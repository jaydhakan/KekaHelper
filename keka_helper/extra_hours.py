...
class KekaExtraHoursCalculator:
    ...
    def calculate_extra_time_and_get_message(
        ...
        return build_extra_hours_notification(self.working_days, total_effective, office_time)
...
class KekaExtraHoursCalculatorV2:
    ...
    def _build_notification(
        ...
        return build_extra_hours_notification(working_days, total_effective, self.daily_office_time)
